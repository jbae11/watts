...
for end_year, output_folder in zip(end_years, output_folders):
    ...
    # print the end year price of the gcmat_result.csv_data
    print(f'end year {end_year} price: {gcmat_result.csv_data["U buyer price US"].iloc[-1]}')
